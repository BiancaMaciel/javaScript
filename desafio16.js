(function(){
    ...
    */
    console.log( '\nMeus amigos:' );
    var arr = ['marcos','bia', 'fabi', 'li', 'mãe'];
    ...
    */
    console.log( '\nEra "Roberto", agora é:' );
    var name = 'Roberto';
    var lastLetter = name.charAt(6).replace('o', 'a');
    console.log(name.slice(0, 6).concat(lastLetter));
    ...
    */
    console.log( '\nParte de uma string:' ); console.log('Fernando'.substring(8, 3, 'nando'));
