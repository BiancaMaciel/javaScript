(function () {
    ...
    */
    ...
    Esse retorno estava mostrando como sendo false, pq '5' é uma string.
    */
    //Forma correta
    var five = Number('5');
    console.log( five + ' é número?', typeof five === 'number' );
    ...
    Não deu o resultado esperado porque concat é um numero, tem que passar para string 
    */
    //Forma correta
    ...
    */
    ...
    //É possível otimizar esse return da seguinte forma : operation[operator] !== undefined;
    
    // Como também é possível utilizar o Truthy e Falsy, sabemos que o undefined é false, function, string são truthy.
    //!! dois sinais de not retorna o booleano
    ...
    */
    function showErrorMessage(operator, num1, num2) {
