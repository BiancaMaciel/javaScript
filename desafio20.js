(function (win, doc) {
    ...
    */    
    ...
    //curto-circuito ou ||verifica o lado esquerdo da expressão se for verdadeira adiciona na variavel se não ele atribui o valor segundo valor.... ou e && os dois tem que ser verdadeiro
